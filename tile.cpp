...
Tile Tile::rotate(int a) {
  assert(a==90|| a==180||a==0||a==270);
  if (a==90){
    rotation_=90;
    return Tile(west_, north_, east_, south_);
  }
  else if (a==180){
    rotation_=180;
    return Tile(south_, west_, north_, east_);
  }
  else if (a==270){
    rotation_=270;
    return Tile(east_, south_, west_, north_);
  }
  else{
    rotation_=0;
    return Tile(north_, east_, south_, west_);
  }
}
// ==========================================================================
